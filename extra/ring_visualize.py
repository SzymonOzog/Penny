...
for ring_id in range(3):
    ...
    while pe not in pes:
        ...
        ring_pos = (ring_id//2)*2 + my_node*gpus_per_node + local_rank
        ...
        if local_rank == (ring_id // 2) * 2:
            ...
            send_peer = (pe + gpus_per_node + 1) % n_pes
        ...
        print(color, pe, recv_peer, send_peer, recv_chunk, send_chunk, warning)
        pe = send_peer
